...
export default {
  ...
  data() {
    return {
      ...
      url: {
        add: '/project/distributeOrder/outBoundApply',
        edit: '/project/distributeOrder/outBoundApply',
      },
      materialTable: {
        loading: false,
        rowCount: 0,
