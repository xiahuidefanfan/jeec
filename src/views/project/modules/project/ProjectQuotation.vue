    ...
    <div class="project-module-form">
      ...
      <div class="project-module-form-header">
        <div class="project-module-form-title">
          <span v-if="!model.quotationNo">我方报价 - 新增</span>
      ...
      <div class="project-module-form-body">
        <a-spin :spinning="confirmLoading">
          <a-form-model ref="moduleForm" :model="model" :rules="validatorRules">
            <a-row>
               <a-col :span="8">
                <a-form-model-item label="询价方" :labelCol="{ span: 4 }" :wrapperCol="{ span: 19 }" prop="supplierId">
                  <j-search-select-tag
              ...
              <a-col :span="8">
                ...
                >
                  <a-input v-model="model.customerContactPerson" :disabled="true" placeholder="请输入" />
                </a-form-model-item>
              </a-col>
              <a-col :span="8">
                <a-form-model-item
                ...
                >
                  <a-input v-model="model.customerContactPhone" :disabled="true" placeholder="请输入" />
                </a-form-model-item>
              </a-col>
              <a-col :span="8">
                <a-form-model-item
                ...
                >
                  <a-input v-model="model.customerContactEmail" :disabled="true" placeholder="请输入" />
                </a-form-model-item>
              </a-col>
              ...
              <a-col :span="8">
                <a-form-model-item label="税点" :labelCol="{ span: 4 }" :wrapperCol="{ span: 19 }" prop="taxPoint">
                  <a-select :disabled="disabled" v-model="model.taxPoint">
                    <a-select-option v-for="option in taxPointOptions" :key="option" :value="option">{{ option }}%</a-select-option>
                  </a-select>
                </a-form-model-item>
              </a-col>
              <a-col :span="8">
...
export default {
  ...
  data() {
    return {
      ...
      validatorRules: {
        customerId: [{ required: true, message: '请选择报价方！' }],
        quotationDate: [{ required: true, message: '请选择报价时间！' }],
  ...
  methods: {
    ...
    createQuotation(record) {
      ...
      customerContactPerson: record.contactPerson,
      customerContactPhone: record.contactPhone,
      customerContactEmail: record.contactEmail,
