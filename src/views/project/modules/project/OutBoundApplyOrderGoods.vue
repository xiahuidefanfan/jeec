<template>
  ...
  >
    <template slot="footer">
      ...
      <a-button v-if="!disableSubmit && action === 'add'" key="submit" @click="outBoundApply" type="primary">出库申请</a-button>
    </template>
...
export default {
  ...
  data() {
    return {
      ...
      materialData:[],
      url: {
        outBoundApplyUrl: '/project/distributeOrder/outBoundApply',
      },
    }
  },
  computed: {
