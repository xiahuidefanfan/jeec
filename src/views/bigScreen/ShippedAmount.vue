<template>
  <div class="business-overview-container">
    <div class="summary-section">
      <div class="summary-item">
        ...
        <div class="summary-content">
          <div class="summary-title">已发货金额</div>
          <div class="summary-value">
            <span class="amount">{{shippedAmount.toLocaleString()}}</span>
    ...
    <div class="order-list-content">
      <vue-seamless-scroll :data="shippedOrderList" :class-option="scrollOption" class="scroll-wrap">
        <div class="order-list-row" v-for="item in shippedOrderList" :key="item.distributeOrderNo">
...
export default {
  ...
  mounted() {
    this.getShippedAmount()
  },
  methods: {
    getShippedAmount() {
      // 调用后端接口获取累计发货金额
      getAction('/bigScreen/shippedAmount').then(res => {
        if (res.success) {
          this.shippedAmount = res.result.shippedAmount || 0
          this.shippedOrderList = res.result.list || 0
        } else {
